...
extern int MaxTrades = 5; // Max Trades (Cycle) [0 = Off]
extern double MinProfit = 0.02; // Min Profit
extern int Dist = 10; // Distance
extern int Step = 800; // Pip Steps
extern M Layer_Multiplier = x18; // Lot Exponent
extern double MaxSpread = 200; // Max Spread [0 = Off]
extern int BreakTime = 60 ; // Break Time (Minutes) [0 = Off]
extern string MoneyManagement = "Money Management Settings"; // ++++++++++
extern bool SetAutoLot; // Use AutoLot
...
extern double TargetPlus = 100; // $ Target Day (+)
extern bool SetMMMinus; // SetMM Risk Loss (-)
extern double TargetMinus = 80; // % Risk Loss (-)
extern string Strategies = "Strategies Settings"; // ++++++++++
extern STRATEGIES SetStrategies = sg_2; // Strategies
extern bool SetAverageBar; // Use Average Bar
...
extern ENUM_HOURS InpStartHour = hour_03; // Start Hour
extern ENUM_HOURS InpEndHour = hour_21; // End Hour
...
extern bool FridayOrders = true; // Friday Orders
